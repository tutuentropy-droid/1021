import { SilentViewingData } from '../types';

export const silentViewingData: SilentViewingData[] = [
  {
    id: 'sv-fuchun',
    ...
    viewingHints: [
      '请看那远山的轮廓，是如何由淡墨渐次晕开的',
      '留意那几株松树的松针，每一笔的走向皆不相同',
      '江面的留白处，似乎有一叶渔舟若隐若现',
      '试闭目片刻，再睁开——画中的云气是否流动了起来'
    ]
  },
  {
    id: 'sv-xishan',
  ...
  },
  {
    ...
    viewingHints: [
      '韩熙载的眼神，在欢宴的人群中为何如此沉郁',
      '那名弹琵琶的女子，她的手指正停在第几根弦上',
      '屏风之间，夜色是如何一段一段地展开的',
      '舞者的裙摆，似乎还在随着节拍旋转'
    ]
  },
...
export function getSilentViewing(): SilentViewingData[] {
  return [...silentViewingData].sort(() => Math.random() - 0.5);
}
